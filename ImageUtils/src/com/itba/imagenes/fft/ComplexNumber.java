...
public class ComplexNumber {
	 ...
	 * 
	 * @param r
	 *            A double representing the real value.
	 * @param i
	 *            A double representing the imaginary value.
	 */
	...
	public static ComplexNumber cDiv(ComplexNumber z1, ComplexNumber z2) {
		...
		z3.imaginary = ((z2.real * z1.imaginary) - (z1.real * z2.imaginary))
				/ n;
		return z3;
	}
