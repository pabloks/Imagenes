			...
			btnActionjButtonBW
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							...
							// TODO Auto-generated Event stub actionPerformed()
							BufferedImage aux = ImageUtils.blackAndWhite(
									_image, Color.RED.toString());
			...
			btnActionjButtonHist
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							System.out.println("actionPerformed() by Browse");
							// TODO Auto-generated Event stub actionPerformed()
							BufferedImage aux = ImageUtils.getHistogram(_image,
									Color.RED.toString());
			...
			btnActionjButtonFilt3
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							...
							BufferedImage aux = ImageUtils.filterImage(_image,
									mask);
