 ...
 * <a href="http://homepages.inf.ed.ac.uk/rbf/HIPR2/hough.htm">http://homepages.
 * inf.ed.ac.uk/rbf/HIPR2/hough.htm</a>
 * </p>
 * <p/>
...
public class HoughTransform extends Thread {
	...
	public static void main(String[] args) throws Exception {
		String filename = "/Users/iandrono/Documents/ITBA/Imagenes/Imagenes/TP2/wdg3.gif";

		// load the file using Java's imageIO library
		BufferedImage image = javax.imageio.ImageIO.read(new File(filename));

		// create a hough transform object with the right dimensions
		HoughTransform h = new HoughTransform(image.getWidth(),
				image.getHeight());

		// add the points from the image (or call the addPoint method separately
		// if your points are not in an image
		h.addPoints(image);
		...
		File outputImageFile = new File(
				"/Users/iandrono/Documents/ITBA/Imagenes/Imagenes/TP2/houghOUTPUT.jpg");
	...
	final int neighbourhoodSize = 20;
